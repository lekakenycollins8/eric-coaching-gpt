...
/**
 * Proxy endpoint to forward Jackier diagnosis requests to the server API
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const apiUrl = `${serverUrl}/api/diagnosis${queryPart}${userQueryParam}`;
    ...
    console.error('Error in diagnosis API route:', error);
    return NextResponse.json(
