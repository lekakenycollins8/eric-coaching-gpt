...
/**
 * Proxy route for /api/followup/worksheets/[id]
...
export async function GET(
  ...
  try {
    ...
    const apiUrl = new URL(`${serverUrl}/api/followup/worksheets/${id}`);
    if (submissionId) {
      apiUrl.searchParams.append('submissionId', submissionId);
    }
    ...
    console.error('Error in worksheet proxy route:', error);
    return NextResponse.json(
